...
export function SignupForm({
  ...
  onFormSubmit: (values: SignupFormValues) => Promise<void> | void
  loading?: boolean
  errors?: string[]
  info?: string | null
  ...
  return (
    <div className={cn("flex flex-col gap-2", className)} {...props}>
            ...
            <FieldGroup className="gap-4">
              <div className="flex flex-col items-center gap-1.5 text-center">
                ...
                <p className="text-sm text-balance text-muted-foreground">
                  Sign up with your health profile details.
                </p>
              </div>
              ...
              <Field>
                ...
                <Input id="name" name="name" placeholder="Mukund Jha" required />
              </Field>
              ...
              <Field>
                ...
                <div className="flex items-center rounded-md border border-input bg-transparent px-3">
                  ...
                  <Input
                    ...
                    className="rounded-none border-0 bg-transparent px-2 shadow-none focus-visible:border-transparent focus-visible:ring-0 dark:bg-transparent"
                  />
                </div>
              </Field>
              ...
              <Field>
                <Button type="submit" disabled={loading || !isPhoneValidOrEmpty}>
      ...
      <FieldDescription className="px-4 text-center text-sm">
