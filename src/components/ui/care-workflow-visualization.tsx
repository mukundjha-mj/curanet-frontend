...
function CareWorkflowVisualization({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[350px] w-full max-w-[500px] flex-col items-center overflow-hidden",
        className
      )}
    >
      <svg
      ...
      <div className="absolute bottom-20 flex w-full flex-col items-center md:bottom-20">
        ...
        <div className="relative z-10 flex h-[210px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          <div className="absolute bottom-8 left-12 z-10 flex h-7 items-center gap-2 rounded-full border bg-[#101112] px-3 text-xs text-white">
            <HeartHandshakeIcon className="size-4" />
            <span>{resolvedButtonTexts.first}</span>
          </div>
          <div className="absolute right-16 z-10 hidden h-7 items-center gap-2 rounded-full border bg-[#101112] px-3 text-xs text-white sm:flex">
