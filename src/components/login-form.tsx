...
export function LoginForm({
  ...
  onFormSubmit: (values: LoginFormValues) => Promise<void> | void
  loading?: boolean
  errors?: string[]
  info?: string | null
  ...
  const canSubmit =
    ...
    (loginMethod === "email" ? emailValue.trim().length > 0 : isPhoneValid)
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-balance text-muted-foreground">
                  Sign in to your CuraNet account
                </p>
              </div>
              <Field>
                <div className="flex items-center justify-between gap-2">
                  <FieldLabel htmlFor={loginMethod === "email" ? "email" : "phone"}>
